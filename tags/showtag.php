...
if(isset($_GET['tagname']))
{
    if(!empty($_GET['tagname']))
    {
        ...
        $getTagName=$_GET['tagname'];
        $catSql="select blogcontent,blogtitle,articleuniqid,articleimg,source,articleview from artitles WHERE blogtags like '%$getTagName%' limit ".CATEGORYNUMBER;
                    ...
                    <div class="articlelist">
                        ...
                        <div class="articledata">
                            ...
                            <div class="articlesumary">
                                <?php echo stripslashes($catRow['blogcontent'])?><!--去掉html标签-->
                            </div>
